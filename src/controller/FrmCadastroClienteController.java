...
public class FrmCadastroClienteController implements Initializable {
    ...
    @FXML
    private PasswordField txtCnpjCpf;
    ...
    @FXML
    private PasswordField txtSobrenome;
	...
	void handleExcluir(ActionEvent event) {
		FrmCadastroClienteDAO cliente = new FrmCadastroClienteDAO();
		cliente.removerUsuario(tblClientes.getSelectionModel().getSelectedItem().getCodigo());
		alimentarTable();
	}
	...
	public void editarCadastroExistente() {
		...
		Usuarios usu = tblClientes.getSelectionModel().getSelectedItem();
